...
import posixpath
import sys
from unicorn import UcError, UC_HOOK_CODE, UC_HOOK_MEM_UNMAPPED, Uc, UC_PROT_ALL, UC_HOOK_MEM_WRITE, UC_HOOK_MEM_READ, UC_PROT_EXEC
...
def hook_mem_write(uc, access, address, size, value, user_data):
    ...
    #
#
g_cfd = ChainLogger(sys.stdout, "./ins-douyin.log")
# Add debugging.
...
# Load all libraries.
lib_module = emulator.load_library("./example_binaries/32/libcms.so", emu64=False)
