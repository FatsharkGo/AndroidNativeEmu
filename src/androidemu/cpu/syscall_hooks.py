...
class SvcHooks64:
    ...
    def __init__(self, mu, syscall_handler, modules: Modules):
        self._mu = mu
        self._syscall_handler = syscall_handler
        self._syscall_handler.set_handler(0x00, "io_setup", 2, self._null)
        self._syscall_handler.set_handler(0x01, "io_destroy", 1, self._null)
...
def SyscallHooks(mu, syscall_handler, modules: Modules, a64: bool):
    if a64:
        return SvcHooks64(mu, syscall_handler, modules)
    else:
        return SvcHooks32(mu, syscall_handler, modules)
