...
class JNIEnv:
    ...
    def get_string_utf_chars(self, mu, env, string, is_copy_ptr):
        ...
        #str_ptr = self._emu.memory_manager.map(0, len(str_val)+1, UC_PROT_READ | UC_PROT_WRITE)
    ...
    def release_string_utf_chars(self, mu, env, string, utf8_ptr):
        ...
        if (utf8_ptr != 0):
            # self._emu.memory_manager.unmap(utf8_ptr, len(pystr)+1)
            self._emu.memory_manager.free(utf8_ptr)
